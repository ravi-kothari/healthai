...
export default function PatientContextPage() {
  const features = [
    {
      title: 'Medical History at a Glance',
      description: 'Instantly see diagnoses, surgeries, hospitalizations, and chronic conditions.',
      icon: History,
    },
    {
      title: 'Care Gap Alerts',
      description: 'Automated detection of overdue screenings, vaccinations, and preventive care.',
      icon: AlertCircle,
    },
    {
      title: 'Pre-Visit Summary',
      description: 'Review patient-submitted symptoms and concerns before walking into the room.',
      icon: FileText,
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-cream-50 via-white to-sand-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-forest-100 rounded-2xl flex items-center justify-center">
              <Activity className="w-10 h-10 text-forest-600" />
            </div>
          </div>
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-8">
            Walk into every appointment fully prepared. All relevant patient information—history, medications, allergies, and recent visits—at your fingertips.
          </p>
          <Link href="/signup">
      ...
      <section className="py-20 bg-gradient-forest text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Be prepared for every patient</h2>
