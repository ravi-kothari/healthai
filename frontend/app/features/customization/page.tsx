  ...
  const features = [
    {
      ...
      description: 'Create and save your own note templates that match your documentation style.',
      icon: Palette,
    },
    {
      title: 'Workflow Automation',
      description: 'Set up automated actions based on patient conditions or visit types.',
      icon: Settings,
    },
    {
      title: 'Preference Controls',
      description: 'Fine-tune AI behavior, output formatting, and terminology preferences.',
      icon: Sliders,
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-cream-50 via-white to-sand-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-forest-100 rounded-2xl flex items-center justify-center">
              <Zap className="w-10 h-10 text-forest-600" />
            </div>
          </div>
          <Badge variant="primary" size="lg" className="mb-6">Personalize Your Experience</Badge>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 mb-6">Customization</h1>
          <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-8">
            Make MedGenie work exactly the way you want. Customize templates, workflows, and AI behavior to match your practice.
          </p>
          <Link href="/signup">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">Customize Everything</h2>
      ...
      <section className="py-20 bg-gradient-forest text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/80 mb-8">Start your 14-day free trial and customize your experience.</p>
          <Link href="/signup">
